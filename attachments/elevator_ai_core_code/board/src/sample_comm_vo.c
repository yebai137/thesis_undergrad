...
#define IOCFG_BASE 0x10260000
#define IOCFG2_BASE 0x179F0000
...
static ot_vo_intf_type g_vo_intf_type = OT_VO_INTF_MIPI;

void sample_comm_vo_set_vo_intf_type(ot_vo_intf_type intf_type)
{
    g_vo_intf_type = intf_type; 
}

ot_vo_intf_type sample_comm_vo_get_vo_intf_type(void)
{
    return g_vo_intf_type;
}

td_s32 sample_vo_clock(ot_vo_intf_type intf_type)
{
    if (intf_type == OT_VO_INTF_BT1120) {
        sample_sys_set_reg(IOCFG2_BASE + 0x0010, 0x100);

        sample_sys_set_reg(IOCFG_BASE + 0x0094, 0x1202);    /* VO_BT1120_DATA0 */
        sample_sys_set_reg(IOCFG_BASE + 0x0090, 0x1202);    /* VO_BT1120_DATA1 */
        sample_sys_set_reg(IOCFG_BASE + 0x0084, 0x1202);    /* VO_BT1120_DATA2 */
        sample_sys_set_reg(IOCFG_BASE + 0x0080, 0x1202);    /* VO_BT1120_DATA3 */
        sample_sys_set_reg(IOCFG_BASE + 0x008C, 0x1202);    /* VO_BT1120_DATA4 */
        sample_sys_set_reg(IOCFG_BASE + 0x0088, 0x1202);    /* VO_BT1120_DATA5 */
        sample_sys_set_reg(IOCFG_BASE + 0x0098, 0x1202);    /* VO_BT1120_DATA6 */
        sample_sys_set_reg(IOCFG_BASE + 0x007C, 0x1202);    /* VO_BT1120_DATA7 */

        sample_sys_set_reg(IOCFG_BASE + 0x00B0, 0x1132);    /* VO_BT1120_CLK */
        sample_sys_set_reg(IOCFG_BASE + 0x00B4, 0x1122);    /* VO_BT1120_DATA8 */
        sample_sys_set_reg(IOCFG_BASE + 0x00AC, 0x1122);    /* VO_BT1120_DATA9 */
        sample_sys_set_reg(IOCFG_BASE + 0x00A4, 0x1122);    /* VO_BT1120_DATA10 */
        sample_sys_set_reg(IOCFG_BASE + 0x00A0, 0x1122);    /* VO_BT1120_DATA11 */
        sample_sys_set_reg(IOCFG_BASE + 0x00A8, 0x1122);    /* VO_BT1120_DATA12 */
        sample_sys_set_reg(IOCFG_BASE + 0x0078, 0x1204);    /* VO_BT1120_DATA13 */
        sample_sys_set_reg(IOCFG_BASE + 0x009C, 0x1202);    /* VO_BT1120_DATA14 */
        sample_sys_set_reg(IOCFG_BASE + 0x0070, 0x1322);    /* VO_BT1120_DATA15 */

        return TD_SUCCESS;

    } else if (intf_type == OT_VO_INTF_MIPI){
        sample_sys_set_reg(IOCFG_BASE + 0x0078, 0x1200);     /* DSI_D3N */
        sample_sys_set_reg(IOCFG_BASE + 0x007C, 0x1200);     /* DSI_D3P */
        sample_sys_set_reg(IOCFG_BASE + 0x0080, 0x1200);     /* DSI_D1N */
        sample_sys_set_reg(IOCFG_BASE + 0x0084, 0x1200);     /* DSI_D1P */
        sample_sys_set_reg(IOCFG_BASE + 0x0088, 0x1200);     /* DSI_CKN */
        sample_sys_set_reg(IOCFG_BASE + 0x008C, 0x1200);     /* DSI_CKP */
        sample_sys_set_reg(IOCFG_BASE + 0x0090, 0x1200);     /* DSI_D0N */
        sample_sys_set_reg(IOCFG_BASE + 0x0094, 0x1200);     /* DSI_D0P */
        sample_sys_set_reg(IOCFG_BASE + 0x0098, 0x1200);     /* DSI_D2N */
        sample_sys_set_reg(IOCFG_BASE + 0x009C, 0x1200);     /* DSI_D2P */
        sample_sys_set_reg(IOCFG2_BASE + 0x0008, 0x1203);    /* VSYNC_TE_MIPITX */

        return TD_SUCCESS;
    } else {
        sample_print("not support %d vo", intf_type);
        return TD_FALSE;
    }
}
